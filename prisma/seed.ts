...
async function main() {
  ...
  const productUpserts = [
    ...
    prisma.product.upsert({
      ...
      create: {
        itemCode: 'PL006',
        description: 'PVC Elbow 90° 2 inch',
        category: 'Plumbing',
  ...
  const invoices = await Promise.all([
    ...
    prisma.invoice.upsert({
      where: { documentNo: 'INV003' },
      update: {},
      create: {
        customerId: 'CUST001',
        documentNo: 'INV003',
        docDate: new Date('2024-02-10'),
        docAmount: 30000.00,
        daysDue: 30,
        docType: 'IN',
        dueAmount: 20000.00,
    ...
    prisma.invoice.upsert({
      where: { documentNo: 'INV005' },
      update: {},
      create: {
        customerId: 'CUST001',
        documentNo: 'INV005',
        docDate: new Date('2024-04-12'),
        docAmount: 60000.00,
        daysDue: 60,
        docType: 'IN',
        dueAmount: 30000.00,
